...
! -----------------------------------------------------
   ...
   !variables not in 4.x but in geoclaw and amr modules from 5.0
      logical :: output_aux_onlyonce, outaux
      integer :: output_q_components(10), output_aux_components(10)
   ...
   do i = 1,10
      output_q_components(i) = 0
      output_aux_components(i)=0
   enddo
